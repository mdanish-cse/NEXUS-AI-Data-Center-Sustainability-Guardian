...
export function NexusLanding() {
  ...
  return <main className="landing-page">
    ...
    <section className="landing-hero">
      ...
      <div className="landing-hero-art" aria-label="NEXUS operational signal preview">
